...
NeptuneLib = require 'neptune-namespaces/NeptuneLib'
{isPlainObject, isString, isFunction, isObject, isPlainArray, isJsonAtomicType} = NeptuneLib.Types

module.exports = class Types
  NeptuneLib.mergeInto @, NeptuneLib.Types
