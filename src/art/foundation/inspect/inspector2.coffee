define [
  ...
  "../neptune_coffee"
  "./inspected"
], (BaseObject, Types, StringExtensions, Map, NeptuneCoffee, Inspected) ->
  ...
  class Inspector2 extends BaseObject
    ...
    inspectObject: (obj, recurse = true) =>
      ...
      if isFunction(obj) and keys.length == 0
        ...
        res.inspected = obj.inspect2() if typeof obj.inspect2 == "function"
        res
    ...
    inspectByType: (obj) ->
      obj = obj.inspectStructure() if isFunction obj?.inspectStructure
      if obj == null ||
          obj == undefined ||
          obj == true ||
          obj == false ||
