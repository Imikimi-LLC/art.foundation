...
module.exports = class ObjectTreeFactory
  ...
  ###
  @createObjectTreeFactory = (nodeFactory, customMergePropsInto = mergeIntoBasic) =>
    ->
      oneProps = null
      props = null
      children = []
  ...
  @createObjectTreeFactoriesFromFactories: (list, nodeFactory, suffix = '', customMergePropsInto = mergeIntoBasic) =>
    out = {}
    for nodeName in compactFlattenObjectTreeNodeNames list
      do (nodeName) =>
  ...
  @createObjectTreeFactoriesFromFactoryFactories: (list, nodeFactoryFactory, suffix = '', customMergePropsInto = mergeIntoBasic) =>
    out = {}
    for nodeName in compactFlattenObjectTreeNodeNames list
      nodeFactory = nodeFactoryFactory nodeName
      out[upperCamelCase(nodeName) + suffix] = @createObjectTreeFactory nodeFactory, customMergePropsInto
    out
